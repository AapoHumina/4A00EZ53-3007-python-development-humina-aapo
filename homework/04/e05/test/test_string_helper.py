...
class TestStringHelper(unittest.TestCase):
    def test_is_name(self):
        ...
        self.assertFalse(is_name(" ville-Kulmala", ignore_case = False))
        self.assertFalse(is_name("Laura KOla", ignore_case = False))
        self.assertFalse(is_name("LAUura Kola", ignore_case = False))
        self.assertFalse(is_name("Laura-MAIja Kola", ignore_case = False))
        self.assertFalse(is_name("Laura-MaIja KOla", ignore_case = False))
